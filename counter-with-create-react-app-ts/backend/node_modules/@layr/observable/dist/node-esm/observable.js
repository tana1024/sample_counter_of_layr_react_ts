import { hasOwnProperty, isClass, getTypeOf, isPlainObject } from 'core-helpers';
/**
...
export function Observable(Base) {
    if (!isClass(Base)) {
        throw new Error(`The Observable mixin should be applied on a class (received type: '${getTypeOf(Base)}')`);
    }
...
export function canBeObserved(value) {
    return ((typeof value === 'object' && value !== null && !(value instanceof Date)) ||
        typeof value === 'function');
}
export function isEmbeddable(value) {
    var _a;
