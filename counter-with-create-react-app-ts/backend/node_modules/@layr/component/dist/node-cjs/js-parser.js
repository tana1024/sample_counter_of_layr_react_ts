...
exports.getAttributeInitializerFromConstructorSourceCode = exports.getConstructorSourceCode = void 0;
const tslib_1 = require("tslib");
const escapeRegExp_1 = tslib_1.__importDefault(require("lodash/escapeRegExp"));
function getConstructorSourceCode(classSourceCode) {
...
exports.getConstructorSourceCode = getConstructorSourceCode;
function getAttributeInitializerFromConstructorSourceCode(constructorSourceCode, attributeName) {
    const regexp = new RegExp(`this\\.${escapeRegExp_1.default(attributeName)}\\s*=\\s*`);
...
exports.getAttributeInitializerFromConstructorSourceCode = getAttributeInitializerFromConstructorSourceCode;
