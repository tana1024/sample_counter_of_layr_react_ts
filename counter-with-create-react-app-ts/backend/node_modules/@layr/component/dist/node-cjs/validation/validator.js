...
exports.runValidators = exports.isSerializedValidator = exports.isValidatorInstance = exports.Validator = void 0;
...
class Validator {
    constructor(func, options = {}) {
        ...
        if (name === undefined) {
            name = core_helpers_1.getFunctionName(func) || 'anonymous';
        }
...
function isValidatorInstance(value) {
    var _a;
    return typeof ((_a = value === null || value === void 0 ? void 0 : value.constructor) === null || _a === void 0 ? void 0 : _a.isValidator) === 'function';
}
exports.isValidatorInstance = isValidatorInstance;
function isSerializedValidator(object) {
    return object !== undefined && core_helpers_1.hasOwnProperty(object, '__validator');
}
exports.isSerializedValidator = isSerializedValidator;
