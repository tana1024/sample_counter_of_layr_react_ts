 ...
 * ```
 */
export declare class SecondaryIdentifierAttribute extends IdentifierAttribute {
 ...
 * @category Utilities
 */
export declare function isSecondaryIdentifierAttributeClass(value: any): value is typeof SecondaryIdentifierAttribute;
/**
 ...
 * @category Utilities
 */
export declare function isSecondaryIdentifierAttributeInstance(value: any): value is SecondaryIdentifierAttribute;
