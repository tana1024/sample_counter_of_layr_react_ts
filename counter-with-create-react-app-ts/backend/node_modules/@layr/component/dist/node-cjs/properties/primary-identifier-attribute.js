...
exports.primaryIdentifierAttributeStringDefaultValue = exports.isPrimaryIdentifierAttributeInstance = exports.isPrimaryIdentifierAttributeClass = exports.PrimaryIdentifierAttribute = void 0;
 ...
 * ```
 */
class PrimaryIdentifierAttribute extends identifier_attribute_1.IdentifierAttribute {
    /**
    ...
    constructor(name, parent, options = {}) {
        if (utilities_1.isComponentInstance(parent) &&
            ...
            throw new Error(`The component '${utilities_1.ensureComponentClass(parent).getComponentName()}' already has a primary identifier attribute`);
        }
    ...
    setOptions(options = {}) {
        ...
        if (valueType === 'string' && defaultValue === undefined) {
            defaultValue = exports.primaryIdentifierAttributeStringDefaultValue;
        }
    ...
    setValue(value, { source = 0 } = {}) {
        ...
        if (previousValue !== undefined && value !== previousValue) {
            throw new Error(`The value of a primary identifier attribute cannot be modified (${this.describe()})`);
        }
     ...
     */
    // === Utilities ===
    static isPrimaryIdentifierAttribute(value) {
        return isPrimaryIdentifierAttributeInstance(value);
    }
}
exports.PrimaryIdentifierAttribute = PrimaryIdentifierAttribute;
/**
 ...
 * @category Utilities
 */
function isPrimaryIdentifierAttributeClass(value) {
    return typeof (value === null || value === void 0 ? void 0 : value.isPrimaryIdentifierAttribute) === 'function';
}
exports.isPrimaryIdentifierAttributeClass = isPrimaryIdentifierAttributeClass;
/**
 ...
 * @category Utilities
 */
function isPrimaryIdentifierAttributeInstance(value) {
    return isPrimaryIdentifierAttributeClass(value === null || value === void 0 ? void 0 : value.constructor) === true;
}
exports.isPrimaryIdentifierAttributeInstance = isPrimaryIdentifierAttributeInstance;
exports.primaryIdentifierAttributeStringDefaultValue = (function () {
    // Makes the function anonymous to make it a bit lighter when serialized
    return function () {
        return this.constructor.generateId();
    };
})();
//# sourceMappingURL=primary-identifier-attribute.js.map