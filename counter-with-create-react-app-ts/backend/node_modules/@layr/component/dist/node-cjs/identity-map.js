...
class IdentityMap {
    ...
    getComponent(identifiers = {}) {
        ...
        for (const identifierAttribute of parent.prototype.getIdentifierAttributes()) {
            ...
            if (!core_helpers_1.hasOwnProperty(index, value)) {
    ...
    updateComponent(component, attributeName, { previousValue, newValue }) {
        ...
        if (newValue !== undefined) {
            if (core_helpers_1.hasOwnProperty(index, newValue)) {
    ...
    _getIndex(name) {
        ...
        else if (!core_helpers_1.hasOwnProperty(indexes, name)) {
    ...
    _getIndexes() {
        ...
        else if (!core_helpers_1.hasOwnProperty(this, '_indexes')) {
