...
export declare type IntrospectedMethod = IntrospectedProperty;
export declare type MethodOptions = PropertyOptions;
/**
 ...
 * @category Utilities
 */
export declare function isMethodClass(value: any): value is typeof Method;
/**
 ...
 * @category Utilities
 */
export declare function isMethodInstance(value: any): value is Method;
