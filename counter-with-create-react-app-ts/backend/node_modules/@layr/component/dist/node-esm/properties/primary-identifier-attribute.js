...
export class PrimaryIdentifierAttribute extends IdentifierAttribute {
    ...
    constructor(name, parent, options = {}) {
        if (isComponentInstance(parent) &&
            ...
            throw new Error(`The component '${ensureComponentClass(parent).getComponentName()}' already has a primary identifier attribute`);
        }
 ...
 * @category Utilities
 */
export function isPrimaryIdentifierAttributeClass(value) {
 ...
 * @category Utilities
 */
export function isPrimaryIdentifierAttributeInstance(value) {
