...
export class ValueType {
    constructor(attribute, options = {}) {
        ...
        const normalizedValidators = validators.map((validator) => normalizeValidator(validator, attribute));
    ...
    checkValue(value, attribute) {
        if (!this._checkValue(value, attribute)) {
            throw new Error(`Cannot assign a value of an unexpected type (${attribute.describe()}, expected type: '${this.toString()}', received type: '${getTypeOf(value)}')`);
        }
    }
