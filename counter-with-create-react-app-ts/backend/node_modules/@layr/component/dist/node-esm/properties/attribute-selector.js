import { hasOwnProperty, getTypeOf, isPlainObject, assertIsFunction } from 'core-helpers';
 ...
 * @category Functions
 */
export function createAttributeSelectorFromNames(names) {
 ...
 * @category Functions
 */
export function createAttributeSelectorFromAttributes(attributes) {
    const attributeSelector = {};
 ...
 * @category Functions
 */
export function getFromAttributeSelector(attributeSelector, name) {
 ...
 * @category Functions
 */
export function setWithinAttributeSelector(attributeSelector, name, subattributeSelector) {
    attributeSelector = normalizeAttributeSelector(attributeSelector);
    if (typeof attributeSelector === 'boolean') {
        return attributeSelector;
    }
 ...
 * @category Functions
 */
export function cloneAttributeSelector(attributeSelector) {
 ...
 * @category Functions
 */
export function attributeSelectorsAreEqual(attributeSelector, otherAttributeSelector) {
 ...
 * @category Functions
 */
export function attributeSelectorIncludes(attributeSelector, otherAttributeSelector) {
    attributeSelector = normalizeAttributeSelector(attributeSelector);
 ...
 * @category Functions
 */
export function mergeAttributeSelectors(attributeSelector, otherAttributeSelector) {
    attributeSelector = normalizeAttributeSelector(attributeSelector);
    otherAttributeSelector = normalizeAttributeSelector(otherAttributeSelector);
 ...
 * @category Functions
 */
export function intersectAttributeSelectors(attributeSelector, otherAttributeSelector) {
    attributeSelector = normalizeAttributeSelector(attributeSelector);
    otherAttributeSelector = normalizeAttributeSelector(otherAttributeSelector);
 ...
 * @category Functions
 */
export function removeFromAttributeSelector(attributeSelector, otherAttributeSelector) {
    attributeSelector = normalizeAttributeSelector(attributeSelector);
    otherAttributeSelector = normalizeAttributeSelector(otherAttributeSelector);
    if (otherAttributeSelector === true) {
        return false;
...
export function iterateOverAttributeSelector(attributeSelector) {
    return {
        *[Symbol.iterator]() {
...
export function pickFromAttributeSelector(value, attributeSelector, options = {}) {
    attributeSelector = normalizeAttributeSelector(attributeSelector);
    if (attributeSelector === false) {
...
function _pick(value, attributeSelector, { includeAttributeNames }) {
    ...
    if (!(isComponent || isPlainObject(value))) {
        throw new Error(`Cannot pick attributes from a value that is not a component, a plain object, or an array (value type: '${getTypeOf(value)}')`);
    }
...
export function traverseAttributeSelector(value, attributeSelector, iteratee, options = {}) {
    attributeSelector = normalizeAttributeSelector(attributeSelector);
...
function _traverse(value, attributeSelector, iteratee, { includeSubtrees, includeLeafs, _context, _isDeep }) {
    ...
    const isComponent = isComponentClassOrInstance(value);
    if (!(isComponent || isPlainObject(value))) {
        throw new Error(`Cannot traverse attributes from a value that is not a component, a plain object, or an array (value type: '${getTypeOf(value)}')`);
    }
    const componentOrObject = value;
...
export function trimAttributeSelector(attributeSelector) {
    attributeSelector = normalizeAttributeSelector(attributeSelector);
    if (typeof attributeSelector === 'boolean') {
        return attributeSelector;
    }
...
export function normalizeAttributeSelector(attributeSelector) {
    ...
    throw new Error(`Expected a valid attribute selector, but received a value of type '${getTypeOf(attributeSelector)}'`);
}
